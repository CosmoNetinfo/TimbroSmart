                    ...
                    <div className="bg-white border border-outline-variant/20 rounded-[32px] p-8 shadow-2xl shadow-primary/5">
                        ...
                        <form onSubmit={handleLogin} className="space-y-5">
                            <div className="relative group">
                                ...
                                <input 
                                    type="password" 
                                    className="w-full h-14 !pl-20 pr-4 bg-surface-container-low border-2 border-transparent focus:border-primary focus:bg-white rounded-2xl transition-all outline-none text-on-surface font-bold tracking-widest placeholder:tracking-normal placeholder:font-normal" 
