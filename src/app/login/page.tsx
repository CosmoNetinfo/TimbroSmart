            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <div className="relative group">
                        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-secondary/60 pointer-events-none material-symbols-outlined text-[20px] transition-colors group-focus-within:text-primary">key</span>
                        <input
                        type="password"
                        placeholder={isRegister ? "Scegli un codice" : "Inserisci il tuo codice"}
                        className="w-full rounded-2xl border-2 border-outline-variant/30 py-4 !pl-20 pr-4 text-on-surface focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all bg-white shadow-sm"
                        value={code}
      ...
      <div className="w-full max-w-md mt-6 space-y-4 animate-slide-up" style={{ animationDelay: '100ms' }}>
        ...
        <div className="bg-[#fff9ed] border border-orange-200 rounded-2xl p-5 text-center shadow-lg relative transition-transform hover:-translate-y-1">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16" className="w-[18px] h-[18px]">
